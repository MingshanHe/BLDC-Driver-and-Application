...
{
    rs2_error* e = 0;
    std::cout<<"[Device Information] Device: "<<rs2_get_device_info(dev, RS2_CAMERA_INFO_NAME, &e)<<std::endl;
    check_error(e);
    std::cout<<"[Device Information] Serial Number: "<<rs2_get_device_info(dev, RS2_CAMERA_INFO_SERIAL_NUMBER, &e)<<std::endl;
    check_error(e);
    std::cout<<"[Device Information] Firmware Version: "<<rs2_get_device_info(dev, RS2_CAMERA_INFO_FIRMWARE_VERSION, &e)<<std::endl;
    check_error(e);
}
